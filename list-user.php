...
<html lang="en">
  ...
  ?>
    <div class="container">
      <?php
      $result2 = mysqli_query($koneksi,"SELECT * FROM user WHERE status = 'Active'");
       ?>
          <h1 class="flow-text center">Daftar User</h1>
              <table class="table highlight responsive-table">
                ...
                <tbody>
                  <tr>
                    ...
                    ?>
                    <td> <a href="blokir.php?id=<?= $user['id'];?>" class="btn yellow black-text waves-effect">Blokir</a> |
